...
axios
  ...
  .catch(err => {
    console.log(`User or Data Not Found: ${err}`)
  });
...
*/
const followersArray = ['https://api.github.com/users/williamschwindt','https://api.github.com/users/HeyMichelle','https://api.github.com/users/candaceyw','https://api.github.com/users/brian-macdowell','https://api.github.com/users/abrobins'];
...
function createUsercard(data){
  ...
  usercard.append(profileImg, cardInfo);
